<script lang="ts">
   ...
   */
  function calculateDuration(start: number, end: number, regionId: number): string {
   ...
   * @param regionId - ID of the region to seek to
   */
